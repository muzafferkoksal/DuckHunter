...
public class BombCreator : MonoBehaviour
{
    ...
    public void spawnBombs()
    {
        ...
        for (int i = 0; i < bomb_count; i++)
        {
            ...
            bomb.GetComponent<Bomb>().x = randx;
            bomb.GetComponent<Bomb>().y = randy;
            bomb.GetComponent<Bomb>().id = i;
            bomb.GetComponent<Bomb>().worldCoor = worldCoor;
            bomb.GetComponent<Bomb>().bombObj = bomb;
